...
<Card title="Bring Your Own Data (BYOD)" icon="pen-to-square" href="/features/byod">
...
<Card title="Advanced Configurations" icon="square-code" href="/features/additional-configs">
  Customize response formats, latency, and other parameters for realistic simulations.
</Card>

<Card title="AI-Powered Data Generation" icon="sparkles" href="/api-reference/introduction">
