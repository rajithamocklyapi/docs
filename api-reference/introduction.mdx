...
```
https://api.mocklyapi.com/mock/{mockApiId}?{queryParameters}
```
...
```
https://api.mocklyapi.com/mock/1f794d0d-8214-4e54-bd89-44d58a3be402?filters=size%3DS&order_by=price&order_direction=desc&limit=2&auth_token=m_bFfgx5z-JigqgvtD-P5aHLg0XgOwlMu-JauO14JGSCw
```
...
- **Domain:** `api.mocklyapi.com` - MocklyAPI's server
